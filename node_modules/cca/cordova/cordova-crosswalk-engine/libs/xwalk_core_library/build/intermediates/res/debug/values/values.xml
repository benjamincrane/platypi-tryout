...
<resources>
    <!-- From: file:/Users/agrieve/git/mca/mobile-chrome-apps/cordova/cordova-crosswalk-engine/libs/xwalk_core_library/res/values/xwalk_resources_list.xml -->
    <eat-comment/>
    <string-array name="xwalk_resources_list">
<item>icudtl.dat</item>
<item>xwalk.pak</item>
</string-array>
    <!-- From: file:/Users/agrieve/git/mca/mobile-chrome-apps/cordova/cordova-crosswalk-engine/libs/xwalk_core_library/res/values/attrs.xml -->
    <eat-comment/>
    <attr format="reference" name="select_dialog_multichoice"/>
    <attr format="reference" name="select_dialog_singlechoice"/>
    <!-- From: file:/Users/agrieve/git/mca/mobile-chrome-apps/cordova/cordova-crosswalk-engine/libs/xwalk_core_library/res/values/colors.xml -->
    <eat-comment/>
    ...
    <!-- From: file:/Users/agrieve/git/mca/mobile-chrome-apps/cordova/cordova-crosswalk-engine/libs/xwalk_core_library/res/values/ui_java_dimens.xml -->
    <eat-comment/>
    ...
    <!-- From: file:/Users/agrieve/git/mca/mobile-chrome-apps/cordova/cordova-crosswalk-engine/libs/xwalk_core_library/res/values/dimens.xml -->
    <eat-comment/>
    <dimen name="link_preview_overlay_radius">7dp</dimen>
    <!-- From: file:/Users/agrieve/git/mca/mobile-chrome-apps/cordova/cordova-crosswalk-engine/libs/xwalk_core_library/res/values/values.xml -->
    <eat-comment/>
    <item name="dropdown_popup_window" type="id"/>
    <!-- From: file:/Users/agrieve/git/mca/mobile-chrome-apps/cordova/cordova-crosswalk-engine/libs/xwalk_core_library/res/values/android_content_strings.xml -->
    <eat-comment/>
    ...
    <!-- From: file:/Users/agrieve/git/mca/mobile-chrome-apps/cordova/cordova-crosswalk-engine/libs/xwalk_core_library/build/intermediates/exploded-aar/android/CordovaLib/unspecified/debug/res/values/values.xml -->
    <eat-comment/>
    <string name="app_name">Cordova</string>
    <!-- From: file:/Users/agrieve/git/mca/mobile-chrome-apps/cordova/cordova-crosswalk-engine/libs/xwalk_core_library/res/values/android_ui_strings.xml -->
    <eat-comment/>
    ...
    <!-- From: file:/Users/agrieve/git/mca/mobile-chrome-apps/cordova/cordova-crosswalk-engine/libs/xwalk_core_library/res/values/android_xwalk_strings.xml -->
    <eat-comment/>
    <string name="cpu_arch_mismatch_message">"Unfortunately this application was not created for %1$s based devices, please take a moment to notify the developer about it. Thanks."</string>
    <string name="cpu_arch_mismatch_title">"Mismatch of CPU architecture for Crosswalk"</string>
    <!-- From: file:/Users/agrieve/git/mca/mobile-chrome-apps/cordova/cordova-crosswalk-engine/libs/xwalk_core_library/res/values/android_content_strings.xml -->
    <eat-comment/>
    ...
    <!-- From: file:/Users/agrieve/git/mca/mobile-chrome-apps/cordova/cordova-crosswalk-engine/libs/xwalk_core_library/res/values/android_xwalk_strings.xml -->
    <eat-comment/>
    <string name="goto_store_button_label">"Go to Google Play Store"</string>
    ...
    <!-- From: file:/Users/agrieve/git/mca/mobile-chrome-apps/cordova/cordova-crosswalk-engine/libs/xwalk_core_library/res/values/android_xwalk_strings.xml -->
    <eat-comment/>
    <string name="report_feedback_button_label">"Report to developer"</string>
    ...
    <!-- From: file:/Users/agrieve/git/mca/mobile-chrome-apps/cordova/cordova-crosswalk-engine/libs/xwalk_core_library/res/values/ui_java_styles.xml -->
    <eat-comment/>
    ...
    <!-- From: file:/Users/agrieve/git/mca/mobile-chrome-apps/cordova/cordova-crosswalk-engine/libs/xwalk_core_library/res/values/styles.xml -->
    <eat-comment/>
