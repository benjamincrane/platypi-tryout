...
#platui {
    #variables {
        ...
        @primary-color-pale: desaturate(@primary-color, 10%);

        @secondary-color: @purple;
        @secondary-color-light: lighten(@secondary-color, 10%);
        @secondary-color-dark: darken(@secondary-color, 8%);
        @secondary-color-pale: desaturate(@secondary-color, 10%);

        /// State/Action Colors

        @success-color: @green;
        @success-color-light: lighten(@success-color, 10%);
        @success-color-dark: darken(@success-color, 8%);
        @success-color-pale: desaturate(@success-color, 10%);

        @danger-color: @red;
        @danger-color-light: lighten(@danger-color, 10%);
        @danger-color-dark: darken(@danger-color, 8%);
        @danger-color-pale: desaturate(@danger-color, 10%);

        @caution-color: @yellow;
        @caution-color-light: lighten(@caution-color, 10%);
        @caution-color-dark: darken(@caution-color, 8%);
        @caution-color-pale: desaturate(@caution-color, 10%);

        @neutral-color: @grey;
        @neutral-color-light: lighten(@neutral-color, 10%);
        @neutral-color-dark: darken(@neutral-color, 10%);
        @neutral-color-pale: desaturate(@neutral-color, 10%);
...
#platui {
    #mixins {
        ...
        .background-clip(@box: border-box) {
            #platui > #variables;
            .background-clip(@box; @webkit-list);
        }
        .background-clip(@box; @vendor-list) when (@box = border-box) {
            -moz-background-clip: border;
            #platui > #__mixins > .vendor-loop(background-clip; @box; @vendor-list);
        }
        .background-clip(@box; @vendor-list) when (@box = padding-box) {
            -moz-background-clip: padding;
            #platui > #__mixins > .vendor-loop(background-clip; @box; @vendor-list);
        }
        .background-clip(@box; @vendor-list) when (default()) {
            #platui > #__mixins > .vendor-loop(background-clip; @box; @vendor-list);
        }
        ...
        .background-size(@args) {
            #platui > #variables;
            .background-size(@args; @webkit-list);
        }
        .background-size(@args; @vendor-list) {
            #platui > #__mixins > .vendor-loop(background-size; @args; @vendor-list);
        }
    }
}
...
#platui {
    #mixins {
        ...
        .animate(@name; @duration: 200ms; @function: ease; @delay: 0s; @count: 1; @direction: normal; @mode: none) {
            #platui > #variables;
            .animate(@name; @duration; @function; @delay; @count; @direction; @mode; @webkit-moz-list);
        }
        .animate(@name; @duration; @function; @delay; @count; @direction; @mode; @vendor-list) {
            #platui > #__mixins > .vendor-loop(animation; @name @duration @function @delay @count @direction @mode; @vendor-list);
        }
        ...
        .animation-fill-mode(@mode) {
            #platui > #variables;
            .animation-fill-mode(@mode; @webkit-moz-list);
        }
        .animation-fill-mode(@mode; @vendor-list) {
            #platui > #__mixins > .vendor-loop(animation-fill-mode; @mode; @vendor-list);
        }
...
#platui {
    #mixins {
        ...
        .transform-style(@style) {
            #platui > #variables;
            .transform-style(@style; @webkit-moz-ms-list);
        }
        ...
        .rotate(@deg; @vendor-list) {
            .transform(rotate(@deg); @vendor-list);
        }

        .scale(@factor: .5) {
            .transform(scale(@factor));
        }
        .scale(@factor; @vendor-list) {
            .transform(scale(@factor); @vendor-list);
        }

        .skew(@deg; @deg2) {
            .transform(skew(@deg, @deg2));
        }
        .skew(@deg; @deg2; @vendor-list) {
            .transform(skew(@deg, @deg2); @vendor-list);
        }
...
#platui {
    #mixins {
        ...
        .transition-all(@duration: 200ms; @function: ease; @delay: 0s) {
            #platui > #variables;
            .transitionAll(all; @duration; @function; @delay; @webkit-moz-list);
        }
        ...
        .transition-timing-function(@function: ease) {
            #platui > #variables;
            .transition-timing-function(@function: ease; @webkit-moz-list);
        }
        .transition-timing-function(@function: ease; @vendor-list) {
...
#platui {
    ...
    /// =========== Checkbox Colors =========== ///
        ...
        @secondary-mark-color: undefined;
        @background-color: @transparent;
        @border-color: @grey;
...
#platui {
    ...
    /// ============== Input Colors =============== ///
        ...
        @action-color: @border-color;
        @placeholder-color: @neutral-color;

    /// =============== Input Sizes =============== ///
    
        @default-height: 2.5em;
        @default-width: 18em;
        @primary-border-bottom-width: 2px;
        @primary-border-bottom: @primary-border-bottom-width solid @border-color;
        @secondary-border-width: 2px;
        @secondary-border: @secondary-border-width solid @border-color;
...
#platui {
    ...
    /// =========== Modal Transitions =========== ///
        ...
        @left-transition: right 500ms;
        @right-transition: left 500ms;
        @up-transition: bottom 500ms;
        @down-transition: top 500ms;
...
#platui {
    ...
    /// =========== Progress Ring Colors =========== ///
        ...
        @fill-color: fade(@ring-color, 75%);
        @unfilled-color: fade(@ring-color, 10%);
    ...
    /// =========== Progress Ring Animation =========== ///
        ...
        @spin-frequency: 600ms;
        
    /// =========== Progress Ring Animation Mixins =========== ///

        .spin() {
            #platui > #animations > .keyframes(@animation-name);
            .frames(@prefix) {
                #platui > #mixins;
                from {
...
#platui {
    ...
    /// =========== Radio Colors =========== ///
        ...
        @mark-color: @checked-border-color;
        @mark-padding-color: @transparent;
...
#platui {
    ...
    /// =============== Range Transitions =============== ///
        ...
        @horizontal-transition: width 300ms;
        @vertical-transition: height 300ms;
    }
}
/**/
...
#platui {
    ...
    /// =========== Toggle Colors =========== ///
        ...
        @border-color: darken(@neutral-color-light, 3%);
        @background-color-off: @neutral-color-light;
        @background-color-on: @success-color;
        @border-color-on: darken(@background-color-on, 5%);
        @toggle-thin-color: lighten(@pale-grey, 10%);
    ...
    /// ========== Toggle Knob Properties ========== ///

        @knob-diameter: @width * @ratio;
        @knob-border-color: darken(@pale-grey, 5%);
        @knob-border-size: 1px;
    ...
    /// ============= Toggle Transition ============= ///
        ...
        @knob-transition: left @transition-time;
    }
}
...
& {
    ...
    /// Phone
	.type(p, @default-font-size, 1.30em);
	.type(h1, 2em, 1.5874em);
	.type(h2, 1.625em, 1.1538em);
	.type(h3, 1.375em, 1.1363em);
	.type(h4, 1.125em, 1.1111em);
	.type(h5, 0.925em, 1.0974em);
	.type(h6, 0.775em, 1.0783em);

    /// Tablet
    .media-tablet({
	    .type(p, @default-font-size, 1.412em);
	    .type(h1, 2.5em, 1.37em);
	    .type(h2, 2em, 1.25em);
	    .type(h3, 1.5em, 1.25em);
	    .type(h4, 1.125em, 1.2222em);
    });

    /// Desktop
    .media-desktop({
	    .type(h1, 3em, 1.3em);
	    .type(h2, 2.25em, 1.25em);
	    .type(h3, 1.75em, 1.25em);
	    .type(h5, 1em, 1.1111em);
	    .type(h6, 0.925em, 1.1111em);
    });
}
...
#platui {
    #__Button {
        #platui > #variables;
        @default-color: @white;
        @default-background-color: @neutral-color;
    }
}

/// ====== Button Default and Outline Style ====== ///
...
.button {
    ...
    color: @default-color;
    outline: none;
    border: @border-size solid @neutral-color-dark;
    cursor: pointer;
...
.plat-carousel {
    ...
    .plat-forward-arrow {
        ...
        .plat-icon-arrow-down::before { content: "\e815"; }
        .plat-icon-arrow-left::before { content: "\e816"; }
        .plat-icon-arrow-right::before { content: "\e817"; }
        .plat-icon-arrow-up::before { content: "\e818"; }
...
.plat-drawer-transition-prep {
    ...
    &.plat-drawer-transition-left {
        .box-shadow(-@shadow-offset 0px @shadow-blur @shadow-spread @shadow-color);
    }
    ...
    &.plat-drawer-transition-top {
        .box-shadow(0px -@shadow-offset @shadow-blur @shadow-spread @shadow-color);
    }
...
/// =============== Input Icon =============== ///
    ...
    &:not(.input-outline) {
        .plat-input-container {
            input {
                border-bottom: @primary-border-bottom;
...
.input-group {
    ...
    .plat-input {
        ...
        input {
            padding-left: 8px;
            padding-right: @action-padding + 0.5em;
        }
...
/// =============== Toggle Thin ================ ///
    ...
    &.toggle-thin {
        .plat-toggle-container {
            ...
            .plat-knob {
                top: @half-thin-height - @knob-radius;
                background-color: @toggle-thin-color;
                border: 1px solid darken(@toggle-thin-color, 10%);
