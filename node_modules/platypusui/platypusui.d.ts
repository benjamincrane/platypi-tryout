...
declare module platui {
    ...
    /**
      ...
      */
    class Carousel extends plat.ui.BindControl implements IUiControl {
        protected static _inject: any;
        /**
          * The HTML template represented as a string.
          */
    ...
    interface IListviewOptions extends plat.ui.controls.IForEachOptions {
        ...
        /**
          ...
          * When the Listview's orientation is vertical the motion will
    ...
    interface IListviewAliasOptions extends plat.ui.controls.IForEachAliasOptions {
        /**
          ...
          * Only can be used in grouped Listviews.
          */
        group?: string;
    }
}
